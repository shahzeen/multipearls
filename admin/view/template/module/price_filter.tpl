      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-filter" class="form-horizontal">
          <div class="form-group">
            ...
            <div class="col-sm-10">
			  <input name="price_filter_range" 	id="input-price-range" value ="<?php echo $price_filter_range; ?>" class="form-control" placeholder="<?php echo $text_price_range; ?>" />
            </div>
          </div>        
		  <div class="form-group">
            <label class="col-sm-2 control-label" for="input-price-class"><?php echo $entry_price_class; ?></label>
            <div class="col-sm-10">
			  <input name="price_filter_class" 	id="input-price-class" value ="<?php echo $price_filter_class; ?>" class="form-control" placeholder="<?php echo $text_price_class; ?>" />
            </div>
          </div>
		  <div class="form-group">
            <label class="col-sm-2 control-label" for="input-price-status"><?php echo $entry_status; ?></label>
            <div class="col-sm-10">
              <select name="price_filter_status" id="input-price-status" class="form-control">
