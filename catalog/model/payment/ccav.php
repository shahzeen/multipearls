<?php
class ModelPaymentCcav extends Model {
	...
	public function proceed($order_info,$app=false)
	{
		$Amount						= $this->currency->format($order_info['total'], $order_info['currency_code'], false, false);
			$Merchant_Id 				= $this->config->get('ccav_merchant_id');
			$access_code 				= $this->config->get('ccav_access_code');
			$Order_Id 					= $this->session->data['order_id'];
			$Url 						= $this->url->link('payment/ccavenuepay/callback');
			$workingKey 				= $this->config->get('ccav_working_key');			
			$Url 						= $this->url->link('payment/ccavenuepay/callback');
			...
			return $this->url->link('payment/ccav/proceed&r='.urlencode($production_url));
