					...
					<ul class="nav nav-tabs" role="tablist" id="module-single-tabs-<?php echo $module; ?>">
						...
						<li>
							<a href="#tab-single-latest-<?php echo $module; ?>" role="tab"
								data-toggle="tab"><?php echo $heading_latest; ?>
							</a>
						</li>
						<?php } ?>
						...
						<li>
							<a href="#tab-single-featured-<?php echo $module; ?>" role="tab"
								data-toggle="tab"><?php echo $heading_featured; ?>
							</a>
						</li>
						<?php } ?>
						...
						<li>
							<a href="#tab-single-specials-<?php echo $module; ?>" role="tab"
								data-toggle="tab"><?php echo $heading_specials; ?>
							</a>
						</li>
						<?php } ?>
						...
						<li>
							<a href="#tab-single-bestsellers-<?php echo $module; ?>" role="tab"
								data-toggle="tab"><?php echo $heading_bestsellers; ?>
							</a>
						</li>
						<?php } ?>
					</ul>
